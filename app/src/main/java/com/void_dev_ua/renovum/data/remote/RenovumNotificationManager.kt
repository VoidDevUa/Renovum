...
object RenovumNotificationManager {
	...
	fun showProgressNotification(context: Context, notificationId: Int) {
		...
		val notification = NotificationCompat.Builder(appContext, EXPORT_CHANNEL_ID)
			...
			.setContentTitle(appContext.getString(R.string.notification_progress_title))
			.setContentText(appContext.getString(R.string.notification_progress_text))
	...
	fun showSuccessNotification(context: Context, file: File, notificationId: Int) {
		...
		val notification = NotificationCompat.Builder(appContext, EXPORT_CHANNEL_ID)
			...
			.setContentTitle(appContext.getString(R.string.report_notification_title))
			.setContentText(appContext.getString(R.string.report_notification_text, file.name))
			.setPriority(NotificationCompat.PRIORITY_DEFAULT)
			.setOngoing(false)
			.setAutoCancel(true)
